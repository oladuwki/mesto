...
popUpCloseButton[0].addEventListener('click', popUpClose);
popUpCloseButton[1].addEventListener('click', popUpClose);
...
function getCardTemplate(card){
  ...
  template.querySelector('.element__image').src = card.link;
